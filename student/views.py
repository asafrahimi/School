...
def TeachersFieldsView(request):
    ...
    if request.method == 'GET':
        ...
        serializer = TeacherSerializer(teacherfield, many =True)
        return JsonResponse(serializer.data, safe =False)
...
def TeacherFieldView(request,nm):
    ...
    if request.method == 'GET':
        serializer = TeacherSerializer(teacherfield)
        return JsonResponse(serializer.data)

    if request.method == 'PUT':
        data = JSONParser().parse(request)
        serializer = TeacherSerializer(teacherfield, data =data)
...
def FieldView(request,nm):
    ...
    if request.method == 'GET':
        serializer = FieldSerializer(teacherfield)
        return JsonResponse(serializer.data)
